        ...
        if (this.props.isLoading) {
            ...
            Content = () => <List>
                {this.props.templates.map(template => (
                    <Link style={{textDecoration: 'none'}} key={template.id} to={'/dashboard/templates/view/' + template.id}>
        ...
        return (
            <Card style={{ marginTop: '15px' }}>
                ...
                <CardActions className="templates-card-actions">
                    <Link to="/dashboard/templates/create" className="templates-new-template-link">
